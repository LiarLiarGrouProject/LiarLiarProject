...
05/01, ST added AI controllers, enum, a gameplay blueprint, and created a file to hold the enum and gameplay blueprint in the .uproject file. These are meant to be used for the Computer Player logic and Game Play logic down the road.
